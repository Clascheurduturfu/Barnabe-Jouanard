...
public class GameEngine {
    ...
    /** All rooms in the game, used for random teleportation. */
    private ArrayList<Room> aTeleportableRooms;
    ...
    private void createRooms() {
        ...
        cascade = new TransporterRoom("in the cascade's vortex! Who knows where you'll end up?", "cascade.gif", "cascade_map.jpeg", this.aTeleportableRooms);
    ...
    private void alea ( final Command pCommand) {
        if (this.aPlayer.getCurrentRoom().isTeleporterRoom() && this.aIsTest) {
            TransporterRoom vTransporterRoom = (TransporterRoom) this.aPlayer.getCurrentRoom();
