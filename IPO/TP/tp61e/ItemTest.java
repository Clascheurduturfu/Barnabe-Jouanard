...
public class ItemTest
{
    ...
    public void testClasse_1()
    {
        ...
        sAbstract = sCla.classType().equals( "class" );
    } // testClasse_1()
    ...
    public void test_constructeur_3()
    {
        ...
        sAttType = "String";  sAttName = "aNom";
        veref.V.verifAttThis( sFil, sAttType, sAttName );
        sAttType = "int";  sAttName = "aPrix";
        veref.V.verifAttThis( sFil, sAttType, sAttName );
    }
    ...
    public void test_toString_5()
    {
        ...
        veref.V.verifMetThis( sFil, "String", "getNom",  true  ); // this.getNom(
        veref.V.verifMetThis( sFil, "int",    "getPrix", true  ); // this.getPrix(
    }
