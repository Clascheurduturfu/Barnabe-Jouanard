...
public class UtilisationTest
{
    ...
    public void test4_essai()
    {
        ...
        sMetRT   = "void";
        sProtoM  = "()";
        sMet = veref.V.getVMetFProto( sCla, sMetName, sMetRT, sProtoM, "public static", "final" );
        veref.V.mesIfNot();        
    } // test4_essai()
    
    @Test
    public void test5_essai()
    {
        test3_constructeurs();
        sMetName = "essai";
        sMetRT   = "void";
    ...
    public void test6_essai()
    {
        ...
        veref.V.verifFileContains( sFil, "new\\s+Point\\s*\\(\\s*\\)", "new Point()", true, false );
        veref.V.verifFileContains( sFil, "new\\s+PointColore\\s*\\(\\s*\\)", "new PointColore()", true, false );
        veref.V.verifFileContains( sFil, "new\\s+PointColore\\s*\\(.*,.*,.*\\)", "new PointColore(,,)", true, false );
        veref.V.verifFileContains( sFil, "\\.equals\\s*\\(.*\\)", "equals(", true, false );
        veref.V.verifFileContains( sFil, "System.out.print", "System.out.print", true, false );
        veref.V.verifCount( sFil, "\\.equals\\(", 3 ); // .equals(
    } // test6_essai()
