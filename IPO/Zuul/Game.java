...
public class Game {
     ...
     *
     * <p>The GUI receives a reference to the engine; the engine is given the GUI so it can print
     * messages and update the display after construction.
     */
    public Game() {
    ...
    /**
     * Entry point when running from command line. Creates a Game object to start the application.
     *
